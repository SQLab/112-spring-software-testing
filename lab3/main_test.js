...
describe('Parameterize', () => {
    ...
    const log_testcases = [
        { param: [10], expected: 2.302585092994046 },// Expected output: Math.log(10)
        { param: [100], expected: 4.605170185988092 },// Expected output: Math.log(100)
        { param: [1], expected: 0 }// Expected output: Math.log(1)
    ];
